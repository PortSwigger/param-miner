...
TriggerBulkScan(Scan scan, IHttpRequestResponse[] reqs, Utilities utilities, BulkScanLauncher luancher) {
  this.scan = scan;
  this.reqs = reqs;
...
TriggerBulkScan(Scan scan, IScanIssue[] issues, Utilities utilities, BulkScanLauncher luancher) {
  this.scan = scan;
  this.issues = issues;
  this.utilities = utilities;
  this.luancher = luancher;
